Vue.component('products', {
   data(){
    ...
    template: `
                <div class="productItems__itemBlock">
                <div class="productItem__hover">
                <a href="#" class="productItem__addBtn" @click="$root.$refs.cart.addProduct(product)">
